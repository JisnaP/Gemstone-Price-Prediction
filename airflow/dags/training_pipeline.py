...
from src.gemstone_price_prediction.pipelines.training_pipelines import TrainingPipeline
...
with DAG(
    ...
    start_date=pendulum.datetime(2024, 1, 17, tz=pendulum.timezone("UTC")),
    catchup=False,
